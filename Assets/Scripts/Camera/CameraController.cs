...
public class CameraController : MonoBehaviour
{
    ...
    public void TeleportCamera()
    {
        if (!isRoomAlchemy)
        {
            Vector3 targetPosition = new Vector3(-19.7f, 18.3f, transform.position.z);
        ...
        {
            Camera.main.orthographicSize = Mathf.Lerp(Camera.main.orthographicSize, 8, cameraZoomSpeed * Time.deltaTime);
        }
